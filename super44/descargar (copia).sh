...
echo http://www.ftp.ncep.noaa.gov/data/nccf/com/gfs/prod/"gfs."$fecha"00"/gfs.t00z.wafs_grb45f06.grib2
...
echo http://www.ftp.ncep.noaa.gov/data/nccf/com/gfs/prod/"gfs."$fecha"06"/gfs.t06z.wafs_grb45f06.grib2
...
echo http://www.ftp.ncep.noaa.gov/data/nccf/com/gfs/prod/"gfs."$fecha"12"/gfs.t12z.wafs_grb45f06.grib2
